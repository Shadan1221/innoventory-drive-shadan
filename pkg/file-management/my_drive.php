                            ...
                            <?php foreach ($folders as $folder): ?>
                                ...
                                <div class="file-card">
                                    ...
                                    <div class="kebab-dropdown" id="<?= $menuId ?>">
                                        ...
                                        <button class="kebab-item"
                                                onclick="window.location.href='download_folder.php?folder=<?= urlencode($folder) ?>&user_id=<?= $viewUserId ?>'">
                                            📥 Download
                                        </button>
                                        
                                        <button class="kebab-item"
                                                onclick="renameFolder('<?= $safeFolder ?>', <?= (int)$viewUserId ?>)">
                                            ✏️ Rename
                                        </button>
                                        
                                        <button class="kebab-item delete"
                                                onclick="deleteFolder('<?= $safeFolder ?>', <?= (int)$viewUserId ?>)">
                                            🗑 Delete
                                        </button>
                                    </div>
                                    ...
                                    <a class="file-download" href="download_folder.php?folder=<?= urlencode($folder) ?>&user_id=<?= $viewUserId ?>">
                                        Download
                                    </a>
                                </div>
                            ...
                            <?php foreach ($files as $file): ?>
                                ...
                                <div class="file-card">
                                    ...
                                    <div class="kebab-dropdown" id="<?= $menuId ?>">
                                        ...
                                        <button class="kebab-item"
                                                onclick="previewFile('<?= $safeFile ?>', <?= (int)$viewUserId ?>)">
                                            👁️ Preview
                                        </button>

                                        <button class="kebab-item"
                                                onclick="renameFile('<?= $safeFile ?>', <?= (int)$viewUserId ?>)">
                                            ✏️ Rename
                                        </button>
